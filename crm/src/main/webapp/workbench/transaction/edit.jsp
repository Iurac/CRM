	...
	$(function (){
		...
		$("#selectActivityBtn").click(function (){
			...
			if(axzLength == 0 ){
				...
				var aid = $axz.val();
				$("#edit-activityId").val(aid);
				$("#edit-activityName").val($("#"+aid).html());
		...
		$("#selectContactsBtn").click(function (){
			...
			if(cxzLength == 0 ){
				...
				var cid = $cxz.val();
				$("#edit-contactsId").val(cid);
				$("#edit-contactsName").val($("#"+cid).html());
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time2" id="edit-expectedDate">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<input type="hidden" id="edit-activityId" name="edit-activityId">
		</div>
		...
		<div class="form-group">
			...
			<input type="hidden" id="edit-contactsId" name="edit-contactsId">
		</div>
