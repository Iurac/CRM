...
<body>
	...
	<input class="hidden" id="hidden-fullname">
	<input class="hidden" id="hidden-company">
	<input class="hidden" id="hidden-phone">
	<input class="hidden" id="hidden-mphone">
	<input class="hidden" id="hidden-state">
	<input class="hidden" id="hidden-source">
	<input class="hidden" id="hidden-owner">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div class="btn-toolbar" role="toolbar" style="background-color: #F7F7F7; height: 50px; position: relative;top: 5px;">
				<div class="btn-group" style="position: relative; top: 18%;">
				  <button type="button" class="btn btn-primary" id="addBtn"></span> 创建</button>
